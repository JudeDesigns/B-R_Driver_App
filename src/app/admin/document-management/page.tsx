                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 text-sm text-gray-500 mb-2">
                            ...
                            <span>Driver: {stop.route.driver?.fullName || stop.route.driver?.username || stop.driverNameFromUpload || 'Unassigned'}</span>
                          </div>
            ...
            <div className="p-6">
              ...
              <div className="mb-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                  ...
                  <div><strong>Driver:</strong> {selectedStopForDetails.route.driver?.fullName || selectedStopForDetails.route.driver?.username || selectedStopForDetails.driverNameFromUpload || 'Unassigned'}</div>
                </div>
              </div>
