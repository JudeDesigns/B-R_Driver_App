    ...
    <div className="h-screen flex bg-white overflow-hidden">
      ...
      <div className="flex flex-1 relative overflow-hidden">
        ...
        <aside
          ...
          } md:translate-x-0 fixed md:static inset-y-0 left-0 z-30 w-64 bg-gray-900 shadow-sidebar transform transition-transform duration-200 ease-in-out md:transition-none flex flex-col h-screen`}
        >
          ...
          <nav className="flex-1 overflow-y-auto p-4">
            <ul className="space-y-2">
              ...
              <li>
                ...
                >
                  {pathname === "/admin/kpis" && (
                    <span className="absolute left-0 top-0 h-full w-1 bg-teal-500"></span>
                  )}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`h-5 w-5 mr-3 transition-all duration-300 ${
                      pathname === "/admin/kpis"
                        ? "text-teal-400"
                        : "text-mono-400 group-hover:text-teal-400"
                    }`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center py-2.5 px-4 text-white rounded-lg transition-all duration-300 relative overflow-hidden group ${
                    pathname === "/admin/document-management"
                      ? "bg-gradient-to-r from-gray-800 to-gray-700 shadow-md"
                      : "hover:bg-gray-800"
                  }`}
                  onClick={() => setSidebarOpen(false)}
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center py-2.5 px-4 text-white rounded-lg transition-all duration-300 relative overflow-hidden group ${
                    pathname === "/admin/system-documents"
                      ? "bg-gradient-to-r from-gray-800 to-gray-700 shadow-md"
                      : "hover:bg-gray-800"
                  }`}
                  onClick={() => setSidebarOpen(false)}
                >
                  ...
                  <span
                    className={`absolute inset-0 w-1 bg-teal-500 transition-all duration-300 ${
                      pathname === "/admin/system-documents"
                        ? "opacity-100"
                        : "opacity-0 group-hover:opacity-100"
                    }`}
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`h-5 w-5 mr-3 text-teal-500 transition-transform duration-300 ${
                      pathname === "/admin/system-documents"
                        ? "scale-110"
                        : "group-hover:scale-110"
                    }`}
